...
GPU Acceleration can also help in the context of any custom Machine Learning models you may want to build, train, deploy and expose as a Web Service (Web API) for consumption in your EmbodiedAI solution. Please find more information about Building and Deploying custom Machine Learning models in Azure Cloud and Edge in these Medium articles: [here](https://alexanikiev.medium.com/building-ai-applications-for-azure-cloud-65252b602042) and [here](https://alexanikiev.medium.com/deploying-ai-models-in-azure-cloud-23f3f52a8813). [PyTorch](https://pytorch.org/) is a popular open source machine learning framework which allows you to build such models and has built-in support for GPU Acceleration. When building and deploying custom models in Azure Cloud you can take advantage of [Azure Machine Learning](https://learn.microsoft.com/en-us/azure/machine-learning/overview-what-is-azure-machine-learning) capabilities. When dealing with Hybrid and Edge scenarios you may consider [Azure Stack](https://azure.microsoft.com/en-us/products/azure-stack) managed appliances, for example, Azure Stack Edge Pro with GPU as described in these Medium articles: [here](https://alexanikiev.medium.com/building-kubernetes-applications-for-azure-stack-edge-be01666831e7) and [here](https://alexanikiev.medium.com/deploying-kubernetes-applications-on-azure-stack-edge-73f64389a59a). For the latter, you may also need to build your own Docker images for models training, running processes optimization or real-time inference. In the table below we provide a handful of options for GPU Accelerated PyTorch applications ([MNIST example](https://github.com/pytorch/examples/blob/main/mnist/main.py)) using NVIDIA GPUs with CUDA support which may be great for training and/or inference.
